...
for id in networkIds:
    ...
    print(len(responseUsers))
    for user in responseUsers:
        list_of_users.append(user['email'])
        #print(user['email'])
    #print(len(list_of_users))
    dct_of_lists['network_%s' % id] = list_of_users # create new dicstionary for each of our networks
    #print(dct_of_lists.keys())

print(len(dct_of_lists['network_L_682858293500053633']))
print(len(dct_of_lists['network_L_682858293500059085']))
print(len(dct_of_lists['network_L_714946440845069449']))
print(len(dct_of_lists['network_L_714946440845072487']))
